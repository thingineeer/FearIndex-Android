...
- **미검증/주의**: ① 실기기 + 프로덕션 광고 미검증(배포 후 확인) ② **1.3.x 알려진 이슈**: #96 MotionEvent recycled twice 랜덤 크래시(광고 밖 스크롤 중에도), #85 App Open show NPE — 배포 후 Crashlytics 감시, 재현 시 1.2.1 다운그레이드/1.3.2 대기 판단 ③ 배포 후 AdMob 배너 match rate/eCPM 을 마이그레이션 전 기준선과 비교(#62 fill 하락 보고) ④ NG lifecycle: v1.x Deprecation Q1 2028.
