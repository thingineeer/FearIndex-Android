...
| v1.5.3 | 25 | 2026-08-19 | 게시 완료 ✅ (이후 1.6.0 으로 대체) | 배너 콜드스타트 fix(66) + 알림 보관 표시/영속 분리(65) + 어댑터 진단(62). changelog 25 45 locale |
| v1.6.0 | **26** | 2026-08-21 | **production 게시 ✅ 100%** — ⚠️ **이 레포에 소스 없음(다른 맥 push 누락)** | 릴리즈노트 "Improved notification registration reliability and security verification". Crashlytics 신규 `AppCheckTokenProbe` 코드 포함. 상세 @bugs-fixed.md 68번 |
