...
| v1.5.2 | 23 | 2026-08-18 | **내부 테스트 업로드 ✅** (Production 승격 안 함) | **GMA Next-Gen SDK 1.3.1**(레거시 제거, Kotlin 2.2.21/Hilt 2.58) + Pangle 8.2.0.4.0 + AppOpen 유닛 + Billing ensureConnected ANR fix + **프리미엄 parity 4종**(점수 탐색기·알림 내역·프리미엄 게이트·DEBUG 결제 토글, bugs-fixed 59번). changelog 23 45 locale. fastlane internal "Successfully finished the upload", 트랙 검증 internal=[23,22]/production=[22] |
