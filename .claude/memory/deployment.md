...
| v1.5.3 | **25** | 2026-08-19 16:58 | **게시 완료 ✅** (Play "Google Play에 제공됨", 177개국 100%, 8/21 설치 403회, Crashlytics crash-free 100%, API 36 정책 경고 해소) | 배너 콜드스타트 fix(66) + 알림 보관 표시/영속 분리(65) + 어댑터 진단(62). changelog 25 45 locale. **게시 후 모니터링에서 Android App Check 전수 실패(68번) 발견 → 콘솔 수정(Play 앱 서명 키 SHA-256 Firebase 등록 + Play Integrity API Cloud 프로젝트 연결)으로 8/21 06:05Z 복구.** 다음 배포 vc26 |
